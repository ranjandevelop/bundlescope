  ...
  return (
    <>
      <Container>
        ...
        <Header />
        <BundleScope />
        {/* <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.05] md:p-6 backdrop-blur">
          ...
          <div class="flex items-end justify-between mt-5">
            ...
            <span class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium text-sm bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500">
              <svg
                class="fill-current"
                width="1em"
                height="1em"
