    ...
    <>
      <section class="pt-12 lg:pt-16 bg-gradient-to-b from-[#E9FFFE] via-[#F6FFE7] to-white pb-12 lg:pb-16">
        <div class="max-w-7xl mx-auto px-4 xl:px-0 flex flex-col items-center">
          ...
          <div class="mt-8 bg-gradient-to-b from-slate-800 to-slate-600 bg-clip-text text-center text-3xl font-semibold text-transparent sm:w-2/3 md:w-1/2 lg:mt-9 lg:text-4xl lg:leading-tight xl:w-1/2">
            Stay in the Loop with Our Exclusive Newsletter
          </div>
          <p class="mt-4 text-center text-sm font-medium text-neutral-500 sm:w-1/2 lg:w-2/5">
            Get the latest updates, industry insights, and exclusive offers
            delivered straight to your inbox.
          </p>
          <div class="mt-8 flex flex-wrap items-center justify-center gap-3 md:mt-10 xl:mt-12">
            <a
              href="#"
              title="Learn more"
              class="items-center justify-center whitespace-nowrap text-sm font-medium transition-all focus:shadow-[0_0px_0px_2px_rgba(15,23,42,0.25),0_2px_10px_0px_rgba(0,0,0,0.05)] shadow-[0_2px_10px_0px_rgba(0,0,0,0.05)] border border-neutral-100 bg-white text-neutral-700 hover:border-neutral-200 hover:bg-neutral-100 disabled:border-slate-900/5 disabled:bg-slate-50/30 disabled:text-slate-900/20 px-4 py-2.5 rounded-[0.625rem] flex"
            >
              <svg
                class="shrink-0 mr-2 h-4"
            ...
            >
              Try free
              <span class="ml-1 text-slate-400"> - 14 days</span>
              <svg
                class="shrink-0 ml-2 h-4"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
                aria-hidden="true"
